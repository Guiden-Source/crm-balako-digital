  ...
  try {
    ...
    if (assigned_to !== userId) {
      ...
      await sendEmail({
        ...
        subject: `Novo contato ${first_name} ${last_name} foi adicionado ao sistema e atribuído a você.`,
        text: `Novo contato ${first_name} ${last_name} foi adicionado ao sistema e atribuído a você. Você pode ver os detalhes aqui: ${process.env.NEXT_PUBLIC_APP_URL}/crm/contacts/${newContact.id}`,
      });
    }
