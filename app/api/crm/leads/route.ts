  ...
  try {
    ...
    if (assigned_to !== userId) {
      ...
      await sendEmail({
        ...
        subject: `Novo lead ${first_name} ${last_name} foi adicionado ao sistema e atribuído a você.`,
        text: `Novo lead ${first_name} ${last_name} foi adicionado ao sistema e atribuído a você. Você pode ver os detalhes aqui: ${process.env.NEXT_PUBLIC_APP_URL}/crm/leads/${newLead.id}`,
      });
    }
